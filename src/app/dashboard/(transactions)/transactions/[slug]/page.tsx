...
export const generateMetadata = async ({
  ...
  return {
    title: `Penny Tracker | Update Transaction`,
    description: `View and update the details of transaction: ${transactionData.id}`,
    openGraph: {
      title: `Penny Tracker | Update Transaction`,
      description: `View and update the details of transaction: ${transactionData.description} `,
      images: [
        {
          url: "logo.svg",
          width: 800,
